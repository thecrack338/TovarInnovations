...
db.ref('config').on('value', snapshot => {
  ...
  configAdmin = data || { whatsapp:'', email:'', nombre:'TOVARINNOVATIONS', pass:'admin123' };
});
...
$('saveBtn').onclick = () => {
  ...
  alertBox.textContent = editandoId ? '✔ Producto actualizado' : '✔ Producto agregado';
